...
- (instancetype)init
{
    self = [super initWith:@"Device" info:@"Please select the device you are currently using.  Selecting the wrong device will distort output." itemId:WIZARD_ITEM_DEVICE type:WizardItemDataTypeString];
    if (self) {
