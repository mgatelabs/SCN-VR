...
{
    self = [super initWith: second ? @"... Value 2" : @"... Value 1" info:@"Complex math nonsense" itemId: second ? WIZARD_ITEM_DISTORTION_VALUE2 : WIZARD_ITEM_DISTORTION_VALUE1 type:WizardItemDataTypeInt];
    if (self) {
        isSecond = second;
